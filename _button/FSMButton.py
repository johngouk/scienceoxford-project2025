...
# Released under the MIT License (MIT) - see LICENSE file
    ...
    ST_WAIT_PRESS	Waiting for a first press
    ST_WAIT_REL		Waiting for release after first press
    ST_WAIT_DPRESS	Waiting for second press of a Double
    ST_WAIT_DLREL	Waiting for Long release or a Double release
    
    Events:
    F2T		False to True = Press
    T2F		True to False = Release
    DTimer	Double press wait timer expires
    LTimer	Long press wait timer expires
